Q.5 Get employee details from employee table whose first name contains ‘J’.


Table employee
```sql
create TABLE Employee (Employee_id int, 
First_name varchar(20),Last_name varchar(20),Salary int, Joining_date datetime,Department varchar(20));
...
output:
![](ss\Screenshot_2024-10-05_223455.png)
